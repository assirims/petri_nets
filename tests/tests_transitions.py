...
class TestTransitions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.c1 = Connector(self.p1, Direction.PLACE_TO_TRANSITION, 1)
        self.c2 = Connector(self.p2, Direction.TRANSITION_TO_PLACE, 1)
        self.c3 = Connector(self.p2, Direction.PLACE_TO_TRANSITION, 1)
